...
import styles from "./shopping-page-empty.module.css";
const ShoppingPageEmpty: FunctionComponent = () => {
  ...
  return (
    <div className={styles.shoppingPageEmpty}>
      <div
      ...
      />
      <div className={styles.shoppingPageEmptyChild} />
      <Component1
...
export default ShoppingPageEmpty;
